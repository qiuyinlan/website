                ...
                service.dm = (function() {
                    ...
                    dm.v1 = (function() {
                        ...
                        v1.DmWebViewReply = (function() {
                            ...
                            DmWebViewReply.decode = function decode(r, l) {
                                ...
                                while (r.pos < c) {
                                    ...
                                    switch (t >>> 3) {
                                        ...
                                        case 9:
                                            ...
                                            break;
                                        case 10:
                                            m.dmSetting = $root.bilibili.community.service.dm.v1.DanmuWebPlayerConfig.decode(r, r.uint32());
                                            break;
                                        case 11:
                                            if (!(m.reportFilter && m.reportFilter.length))
                                                m.reportFilter = [];
                                            m.reportFilter.push(r.string());
                                            break;
                                        default:
                                            r.skipType(t & 7);
                                            break;
                            ...
                            DmWebViewReply.verify = function verify(m) {
                                if (typeof m !== "object" || m === null)
                                    return "object expected";
                                if (m.state != null && m.hasOwnProperty("state")) {
                                    if (!$util.isInteger(m.state))
                                ...
                                if (m.textSide != null && m.hasOwnProperty("textSide")) {
                                    if (!$util.isString(m.textSide))
                                        return "textSide: string expected";
                                }
                                if (m.dmSge != null && m.hasOwnProperty("dmSge")) {
                                    {
                                        var e = $root.bilibili.community.service.dm.v1.DmSegConfig.verify(m.dmSge);
                                        if (e)
                                            return "dmSge." + e;
                                    }
                                }
                                if (m.flag != null && m.hasOwnProperty("flag")) {
                                    {
                                        var e = $root.bilibili.community.service.dm.v1.DanmakuFlagConfig.verify(m.flag);
                                        if (e)
                                            return "flag." + e;
                                    }
                                }
                                if (m.specialDms != null && m.hasOwnProperty("specialDms")) {
                                    if (!Array.isArray(m.specialDms))
                                        return "specialDms: array expected";
                                    for (var i = 0; i < m.specialDms.length; ++i) {
                                        if (!$util.isString(m.specialDms[i]))
                                            return "specialDms: string[] expected";
                                    }
                                }
                                if (m.checkBox != null && m.hasOwnProperty("checkBox")) {
                                    if (typeof m.checkBox !== "boolean")
                                        return "checkBox: boolean expected";
                                }
                                if (m.count != null && m.hasOwnProperty("count")) {
                                    if (!$util.isInteger(m.count) && !(m.count && $util.isInteger(m.count.low) && $util.isInteger(m.count.high)))
                                        return "count: integer|Long expected";
                                }
                                if (m.commandDms != null && m.hasOwnProperty("commandDms")) {
                                    if (!Array.isArray(m.commandDms))
                                        return "commandDms: array expected";
                                    for (var i = 0; i < m.commandDms.length; ++i) {
                                        {
                                            var e = $root.bilibili.community.service.dm.v1.CommandDm.verify(m.commandDms[i]);
                                            if (e)
                                                return "commandDms." + e;
                                        }
                                    }
                                }
                                if (m.dmSetting != null && m.hasOwnProperty("dmSetting")) {
                                    {
                                        var e = $root.bilibili.community.service.dm.v1.DanmuWebPlayerConfig.verify(m.dmSetting);
                                        if (e)
                                            return "dmSetting." + e;
                                    }
                                }
                                if (m.reportFilter != null && m.hasOwnProperty("reportFilter")) {
                                    if (!Array.isArray(m.reportFilter))
                                        return "reportFilter: array expected";
                                    for (var i = 0; i < m.reportFilter.length; ++i) {
                                        if (!$util.isString(m.reportFilter[i]))
                            ...
                            DmWebViewReply.fromObject = function fromObject(d) {
                                ...
                                if (d.dmSetting != null) {
                                    if (typeof d.dmSetting !== "object")
                                        throw TypeError(".bilibili.community.service.dm.v1.DmWebViewReply.dmSetting: object expected");
                                    m.dmSetting = $root.bilibili.community.service.dm.v1.DanmuWebPlayerConfig.fromObject(d.dmSetting);
                                }
                                if (d.reportFilter) {
                                    if (!Array.isArray(d.reportFilter))
                                        throw TypeError(".bilibili.community.service.dm.v1.DmWebViewReply.reportFilter: array expected");
                                    m.reportFilter = [];
                                    for (var i = 0; i < d.reportFilter.length; ++i) {
                                        m.reportFilter[i] = String(d.reportFilter[i]);
                                    }
                                }
                                return m;
                            };
                            ...
                            DmWebViewReply.toObject = function toObject(m, o) {
                                ...
                                if (m.dmSetting != null && m.hasOwnProperty("dmSetting")) {
                                    d.dmSetting = $root.bilibili.community.service.dm.v1.DanmuWebPlayerConfig.toObject(m.dmSetting, o);
                                }
                                if (m.reportFilter && m.reportFilter.length) {
                                    d.reportFilter = [];
                                    for (var j = 0; j < m.reportFilter.length; ++j) {
                                        d.reportFilter[j] = m.reportFilter[j];
                                    }
                                }
                                return d;
                            };
                        ...
                        v1.CommandDm = (function() {
                            ...
                            CommandDm.decode = function decode(r, l) {
                                if (!(r instanceof $Reader))
                                    r = $Reader.create(r);
                            ...
                            CommandDm.verify = function verify(m) {
                                if (typeof m !== "object" || m === null)
                                    return "object expected";
                                if (m.oid != null && m.hasOwnProperty("oid")) {
                                    if (!$util.isInteger(m.oid) && !(m.oid && $util.isInteger(m.oid.low) && $util.isInteger(m.oid.high)))
                                        return "oid: integer|Long expected";
                                }
                                if (m.mid != null && m.hasOwnProperty("mid")) {
                                    if (!$util.isInteger(m.mid) && !(m.mid && $util.isInteger(m.mid.low) && $util.isInteger(m.mid.high)))
                                        return "mid: integer|Long expected";
                                }
                                if (m.command != null && m.hasOwnProperty("command")) {
                                    if (!$util.isString(m.command))
                                ...
                                if (m.ctime != null && m.hasOwnProperty("ctime")) {
                                    if (!$util.isString(m.ctime))
                                        return "ctime: string expected";
                                }
                                if (m.mtime != null && m.hasOwnProperty("mtime")) {
                                    if (!$util.isString(m.mtime))
                        ...
                        v1.DmSegConfig = (function() {
                            ...
                            DmSegConfig.decode = function decode(r, l) {
                                if (!(r instanceof $Reader))
                                    r = $Reader.create(r);
                            ...
                            DmSegConfig.verify = function verify(m) {
                                if (typeof m !== "object" || m === null)
                                    return "object expected";
                                if (m.pageSize != null && m.hasOwnProperty("pageSize")) {
                                    if (!$util.isInteger(m.pageSize) && !(m.pageSize && $util.isInteger(m.pageSize.low) && $util.isInteger(m.pageSize.high)))
                                        return "pageSize: integer|Long expected";
                                }
                                if (m.total != null && m.hasOwnProperty("total")) {
                                    if (!$util.isInteger(m.total) && !(m.total && $util.isInteger(m.total.low) && $util.isInteger(m.total.high)))
                        ...
                        v1.DanmakuFlagConfig = (function() {
                            ...
                            DanmakuFlagConfig.decode = function decode(r, l) {
                                if (!(r instanceof $Reader))
                                    r = $Reader.create(r);
                        ...
                        v1.DmSegMobileReply = (function() {
                            ...
                            DmSegMobileReply.verify = function verify(m) {
                                if (typeof m !== "object" || m === null)
                                    return "object expected";
                                if (m.elems != null && m.hasOwnProperty("elems")) {
                                    ...
                                    for (var i = 0; i < m.elems.length; ++i) {
                                        {
                                            var e = $root.bilibili.community.service.dm.v1.DanmakuElem.verify(m.elems[i]);
                                            if (e)
                                                return "elems." + e;
                                        }
                                    }
                        ...
                        v1.DanmakuElem = (function() {
                            ...
                            DanmakuElem.verify = function verify(m) {
                                if (typeof m !== "object" || m === null)
                                    return "object expected";
                                if (m.progress != null && m.hasOwnProperty("progress")) {
                                    if (!$util.isInteger(m.progress))
                                ...
                                if (m.mode != null && m.hasOwnProperty("mode")) {
                                    if (!$util.isInteger(m.mode))
                                        return "mode: integer expected";
                                }
                                if (m.fontsize != null && m.hasOwnProperty("fontsize")) {
                                    if (!$util.isInteger(m.fontsize))
                                ...
                                if (m.ctime != null && m.hasOwnProperty("ctime")) {
                                    if (!$util.isInteger(m.ctime) && !(m.ctime && $util.isInteger(m.ctime.low) && $util.isInteger(m.ctime.high)))
                                        return "ctime: integer|Long expected";
                                }
                                if (m.weight != null && m.hasOwnProperty("weight")) {
                                    if (!$util.isInteger(m.weight))
                        ...
                        v1.DanmuWebPlayerConfig = (function() {
                            ...
                            DanmuWebPlayerConfig.decode = function decode(r, l) {
                                if (!(r instanceof $Reader))
                                    r = $Reader.create(r);
                                var c = l === undefined ? r.len : r.pos + l, m = new $root.bilibili.community.service.dm.v1.DanmuWebPlayerConfig();
                                while (r.pos < c) {
                                    var t = r.uint32();
                                    switch (t >>> 3) {
                                        case 1:
                            ...
                            DanmuWebPlayerConfig.verify = function verify(m) {
                                if (typeof m !== "object" || m === null)
                                    return "object expected";
                                if (m.dmSwitch != null && m.hasOwnProperty("dmSwitch")) {
                                    if (typeof m.dmSwitch !== "boolean")
                                        return "dmSwitch: boolean expected";
                                }
                                if (m.aiSwitch != null && m.hasOwnProperty("aiSwitch")) {
                                    if (typeof m.aiSwitch !== "boolean")
                                        return "aiSwitch: boolean expected";
                                }
                                if (m.aiLevel != null && m.hasOwnProperty("aiLevel")) {
                                    if (!$util.isInteger(m.aiLevel))
                                        return "aiLevel: integer expected";
                                }
                                if (m.typeTop != null && m.hasOwnProperty("typeTop")) {
                                    if (typeof m.typeTop !== "boolean")
                                        return "typeTop: boolean expected";
                                }
                                if (m.typeScroll != null && m.hasOwnProperty("typeScroll")) {
                                    if (typeof m.typeScroll !== "boolean")
                                        return "typeScroll: boolean expected";
                                }
                                if (m.typeBottom != null && m.hasOwnProperty("typeBottom")) {
                                    if (typeof m.typeBottom !== "boolean")
                                        return "typeBottom: boolean expected";
                                }
                                if (m.typeColor != null && m.hasOwnProperty("typeColor")) {
                                    if (typeof m.typeColor !== "boolean")
                                        return "typeColor: boolean expected";
                                }
                                if (m.typeSpecial != null && m.hasOwnProperty("typeSpecial")) {
                                    if (typeof m.typeSpecial !== "boolean")
                                        return "typeSpecial: boolean expected";
                                }
                                if (m.preventshade != null && m.hasOwnProperty("preventshade")) {
                                    if (typeof m.preventshade !== "boolean")
                                        return "preventshade: boolean expected";
                                }
                                if (m.dmask != null && m.hasOwnProperty("dmask")) {
                                    if (typeof m.dmask !== "boolean")
                            ...
                            DanmuWebPlayerConfig.fromObject = function fromObject(d) {
                                ...
                                if (d.typeTop != null) {
                                    m.typeTop = Boolean(d.typeTop);
                                }
                                if (d.typeScroll != null) {
                                    m.typeScroll = Boolean(d.typeScroll);
                                }
                                if (d.typeBottom != null) {
                                    m.typeBottom = Boolean(d.typeBottom);
                                }
                                if (d.typeColor != null) {
                                    m.typeColor = Boolean(d.typeColor);
                                }
                                if (d.typeSpecial != null) {
                                    m.typeSpecial = Boolean(d.typeSpecial);
                                }
                                ...
                                if (d.fullscreensync != null) {
                                    m.fullscreensync = Boolean(d.fullscreensync);
                                }
                                if (d.speedsync != null) {
                            ...
                            DanmuWebPlayerConfig.toObject = function toObject(m, o) {
                                ...
                                if (m.typeScroll != null && m.hasOwnProperty("typeScroll")) {
                                    d.typeScroll = m.typeScroll;
                                }
                                if (m.typeBottom != null && m.hasOwnProperty("typeBottom")) {
                                    d.typeBottom = m.typeBottom;
                                }
                                if (m.typeColor != null && m.hasOwnProperty("typeColor")) {
                                    d.typeColor = m.typeColor;
                                }
                                if (m.typeSpecial != null && m.hasOwnProperty("typeSpecial")) {
                                    d.typeSpecial = m.typeSpecial;
                                }
                                if (m.preventshade != null && m.hasOwnProperty("preventshade")) {
                                ...
                                if (m.fullscreensync != null && m.hasOwnProperty("fullscreensync")) {
                                    d.fullscreensync = m.fullscreensync;
                                }
                                if (m.speedsync != null && m.hasOwnProperty("speedsync")) {
